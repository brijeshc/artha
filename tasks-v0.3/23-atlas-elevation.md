...
**Status: 23a/23a′/23a″ shipped 2026-07-07; 23b (inner boards) shipped 2026-07-08; 23c (the observatory) shipped 2026-07-09; 23d-1 (evidence revealed, D5) + 23d-2 (vouch-by-reading / materialize-on-touch, D9 core + OQ-A) shipped 2026-07-09; the rest of 23d + 23e specced below, sequenced by impact per effort.**
...
- The review *walk* (rest of D9): `R` on any module/capability page walks claim by claim - claim left, pinned code right; `j`/`k` move, one keystroke per decision (vouch reuses 23d-2, edit reuses the edit path, `x` flag awaits T22's disagreement surface), exit anywhere. (Reuses `/api/evidence` + `materializeInferred`.)
