...
**Status: re-centering locked; 21a + task 23 + task 24 shipped; 21b underway (21b-1 the synthesis pipeline, 21b-2's flow-step text, and 21b-3 MCP serving done).**
...
**The next work is the rest of 21b** (21b-2's other half - state-machine transitions; then 21b-4 the `uncertain` render), then 22 (contradiction view), then T18.
