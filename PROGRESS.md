...
| 21c  | Inferred layer - dashboard reframe  | 🟡 partial   | two-light grammar, prose-first pages, delta band, worded confidence shipped; flow (Reaches) + convention (Symbols that match) moonlight pages + module/catalog sections shipped in slice 2; **KPI reframe (D11) shipped via 23a**; **evidence revealed (D5) shipped via 23d-1**; vouch-by-reading + value-ranked queue (D9/D10/D6) remain - delivered by the rest of 23d |
| 22   | Contradiction view                  | ⬜            | inferred vs certified |
| 23   | Atlas elevation                     | 🟡 23a+23b+23c+23d-1 done | honest KPIs (% vouched / % described), the **blackboard Board** (handmade flowchart, chalk = light), **inner boards** (23b - drill a module into its own blackboard), **the observatory** (23c - three hand-rolled instrument charts on a fourth nav view, dataviz method), and **evidence revealed** (23d-1 - every pin reveals its exact source lines, D5); next: the rest of 23d (review pass D9, delta band D6, value queue D10), craft debt (23e) - see [tasks-v0.3/23-atlas-elevation.md](tasks-v0.3/23-atlas-elevation.md) |
