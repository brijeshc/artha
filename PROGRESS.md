...
| 23   | Atlas elevation                     | 🟡 23a+23b done | honest KPIs (% vouched / % described), the **blackboard Board** (handmade flowchart, chalk = light), and **inner boards** (23b - drill a module into its own blackboard of files + imports, boxes lit by their pins); next: observatory charts (23c), review pass (23d), craft debt (23e) - see [tasks-v0.3/23-atlas-elevation.md](tasks-v0.3/23-atlas-elevation.md) |
