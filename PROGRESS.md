...
| 21c  | Inferred layer - dashboard reframe  | 🟡 partial   | two-light grammar, prose-first pages, delta band, worded confidence shipped; flow (Reaches) + convention (Symbols that match) moonlight pages + module/catalog sections shipped in slice 2; **KPI reframe (D11) shipped via 23a**; vouch-by-reading + value-ranked queue (D9/D10) remain - delivered by 23d |
| 22   | Contradiction view                  | ⬜            | inferred vs certified |
| 23   | Atlas elevation                     | 🟡 23a+23b+23c done | honest KPIs (% vouched / % described), the **blackboard Board** (handmade flowchart, chalk = light), **inner boards** (23b - drill a module into its own blackboard), and **the observatory** (23c - flying-blind quadrant, vouched burn-up, per-area two-light bars: three hand-rolled instrument charts on a fourth nav view, dataviz method); next: review pass (23d), craft debt (23e) - see [tasks-v0.3/23-atlas-elevation.md](tasks-v0.3/23-atlas-elevation.md) |
