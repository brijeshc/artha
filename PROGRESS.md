...
| 23   | Atlas elevation                     | 🟡 23a done  | honest KPIs (% vouched / % described) + **wiring lens** (import graph as arcs) + **flow routes** (transit lines with numbered stations); next: terrain texture (23b), observatory charts (23c), review pass (23d), craft debt (23e) - see [tasks-v0.3/23-atlas-elevation.md](tasks-v0.3/23-atlas-elevation.md) |
